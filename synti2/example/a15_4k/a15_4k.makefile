...
FILES = example/i15_4k/song.mid \
	   ...
	   example/a15_4k/vertex.vert \
	   example/a15_4k/fragment.frag \
	   example/a15_4k/render.c \
	   example/a15_4k/glfuncs.h \
	   example/a15_4k/glfuncs.c \
	   example/a15_4k/info.txt

CUSTOMFILES=$(FILES)

CUSTOM_FLAGS=-DSCREEN_HEIGHT=360 \
	-DPLAYBACK_DURATION=30 \
	-DAUDIO_BUFFER_SIZE=4096 
