...
#define oglClear        ((CLEAR_F_T)myglfunc[12])
#define oglVertex3i     ((VERTEX3I_F_T)myglfunc[13])
//#define oglBlendFunc    ((BLENDFUNC_F_T)myglfunc[18])
#define oglGetUniformLocation ((GETUNIFORMLOC_F_T)myglfunc[14])
#define oglUniform1fv ((UNIFORM1FV_F_T)myglfunc[15])
//#define oglTranslatef   ((TRANSLATEF_F_T)myglfunc[18])
#define NUMFUNCTIONS 16    //number of functions in *strs function array
