...
const std::string defPatch = "# Default patch; \n"
  ...
  "PHASE ResetOpPhases 0 0x0001   0 5 switch num_ops>0;phase=1 \n"
  "\n"
  "HARM1 Op1Wav 0 0x00ff   0 5 numeric1 num_ops>0;waves=1 \n"
  "HARM2 Op2Wav 0 0x00ff   0 5 numeric1 num_ops>1;waves=1 \n"
  "HARM3 Op3Wav 0 0x00ff   0 5 numeric1 num_ops>2;waves=1 \n"
  "HARM4 Op4Wav 0 0x00ff   0 5 numeric1 num_ops>3;waves=1 \n"
  "\n"
  "POWR1 Op1Power 0 0x0003   0 5 numeric1 num_ops>0;cube=1 \n"
  "POWR2 Op2Power 0 0x0003   0 5 numeric1 num_ops>1;cube=1 \n"
  "POWR3 Op3Power 0 0x0003   0 5 numeric1 num_ops>2;cube=1 \n"
  "POWR4 Op4Power 0 0x0003   0 5 numeric1 num_ops>3;cube=1 \n"
  "\n"
  ...
  "EPIT1 Op1PitchEnv 0 0x002f   0 1 numericOff1 num_envs>0;pitenv=1 \n"
  "EPIT2 Op2PitchEnv 0 0x002f   0 1 numericOff1 num_envs>0;pitenv=1 \n"
  "EPIT3 Op3PitchEnv 0 0x002f   0 1 numericOff1 num_envs>0;pitenv=1 \n"
  "EPIT4 Op4PitchEnv 0 0x002f   0 1 numericOff1 num_envs>0;pitenv=1 \n"
  "\n"
  "EPAN PanEnv       0 0x002f   0 2 numericOff1 num_envs>0;panenv=1\n"
  "EFILT FiltCutEnv  0 0x002f   0 3 numericOff1 num_envs>0;fcutenv=1\n"
  "EFILR FiltResEnv  0 0x002f   0 3 numericOff1 num_envs>0;fresenv=1\n"
  "\n"
  "# Ampl. Velocity sensitivity (0=no effect 1=fully sensitive) \n"
  "\n"
  "VS1 Oper1VelSens   0 0x0001   2 14 switch num_ops>0;velocity=1 \n"
  "VS2 Oper2VelSens   0 0x0001   2 14 switch num_ops>1;velocity=1 \n"
  "VS3 Oper3VelSens   0 0x0001   2 14 switch num_ops>2;velocity=1 \n"
  "VS4 Oper4VelSens   0 0x0001   2 14 switch num_ops>3;velocity=1 \n"
  "VSN NoiseVelSens   0 0x0001   2 4  switch noise=1;velocity=1 \n"
  "VSC FiltCutVelSens 0 0x0001   2 3  switch filter=1;velocity=1 \n"
  "\n"
  ...
  "ELOOP1 En1LoopLen 0 0x0007   0 2 numericOff1 num_envs>0;looping=1 \n"
  "ELOOP2 En2LoopLen 0 0x0007   0 2 numericOff1 num_envs>1;looping=1 \n"
  "ELOOP3 En3LoopLen 0 0x0007   0 2 numericOff1 num_envs>2;looping=1 \n"
  "ELOOP4 En4LoopLen 0 0x0007   0 2 numericOff1 num_envs>3;looping=1 \n"
  "ELOOP5 En5LoopLen 0 0x0007   0 2 numericOff1 num_envs>4;looping=1 \n"
  "ELOOP6 En6LoopLen 0 0x0007   0 2 numericOff1 num_envs>5;looping=1 \n"
  "\n"
  "# need to express 0..1,4\n"
  "FMTO1 FModTo1 0 0x0008   0 3 numericIns num_ops>0;fm=1 \n"
  "FMTO2 FModTo2 0 0x0009   0 3 numericIns num_ops>1;fm=1 \n"
  "FMTO3 FModTo3 0 0x000c   0 3 numericIns num_ops>2;fm=1 \n"
  "FMTO4 FModTo4 0 0x000f   0 3 numericIns num_ops>3;fm=1 \n"
  "\n"
  "ADDTO1 MixTo1 0 0x0008   0 4 numericIns num_ops>0;add=1 \n"
  "ADDTO2 MixTo2 0 0x0009   0 4 numericIns num_ops>1;add=1 \n"
  "ADDTO3 MixTo3 0 0x000c   0 4 numericIns num_ops>2;add=1 \n"
  "ADDTO4 MixTo4 0 0x000f   0 4 numericIns num_ops>3;add=1 \n"
  "\n"
  "# Filter LP,BP,HP,Notch\n"
  "FILT FilterMode 0 0x000f 0 16 filtertype filter=1 \n"
  "\n"
  "# Filter pitch follow source operator\n"
  "FFOLL FiltFollowOsc 0 0x000f 0 16 switch num_ops>0;filter=1;fpfollow=1 \n"
  "\n"
  ...
  "MIXPAN MixPan 0 -1.0 1.0  2 19 float stereo=1 \n"
  "\n"
  ...
  "LVN NoiseLev 0 -8.0 8.0   2 15 float noise=1 \n"
  "LVD DlyInLev 0 -8.0 8.0   2 15 float delay=1 \n"
  "\n"
  "\n"
  ...
  "\n"
  "DT1  Op1Crs 0  -48.0 48.0   1 12  float num_ops>0;pdetune=1\n"
  "DT2  Op2Crs 0  -48.0 48.0   1 12  float num_ops>1;pdetune=1\n"
  "DT3  Op3Crs 0  -48.0 48.0   1 12  float num_ops>2;pdetune=1\n"
  "DT4  Op4Crs 0  -48.0 48.0   1 12  float num_ops>3;pdetune=1\n"
  "\n"
  "#Not used anymore:\n"
  ...
  "PBAM   Op1BendAmt 0 0.0 24.0 1 18 float num_ops>0;pbend=1 \n"
  "PBAM2  Op2BendAmt 0 0.0 24.0 1 18 float num_ops>1;pbend=1 \n"
  "PBAM3  Op3BendAmt 0 0.0 24.0 1 18 float num_ops>2;pbend=1 \n"
  "PBAM4  Op4BendAmt 0 0.0 24.0 1 18 float num_ops>3;pbend=1 \n"
  "# Bend value, not for editing but for pitch bend messages.\n"
  "# Bend is used by patching controller #4 to this value.\n"
  "PBVAL PitchDESTNoEdt 0 -1.0  1.0  2 18 void pbend=1 \n"
  "\n"
  "\n"
  "# Filter parameters; the very basic ones\n"
  "FFREQ Cutoff     0 0.0 128.0   1 17 float filter=1 \n"
  "FRESO Resonance  0 0.0 1.0     2 17 float filter=1;fres=1 \n"
  "\n"
  ...
  "\n"
  "DINLV1 Dly1InLev 0  -1.0 1.0   2 16 float num_delays>0;delay=1 \n"
  "DINLV2 Dly2InLev 0  -1.0 1.0   2 16 float num_delays>1;delay=1 \n"
  "DINLV3 Dly3InLev 0  -1.0 1.0   2 16 float num_delays>2;delay=1 \n"
  "DINLV4 Dly4InLev 0  -1.0 1.0   2 16 float num_delays>3;delay=1 \n"
  "DINLV5 Dly5InLev 0  -1.0 1.0   2 16 float num_delays>4;delay=1 \n"
  "DINLV6 Dly6InLev 0  -1.0 1.0   2 16 float num_delays>5;delay=1 \n"
  "DINLV7 Dly7InLev 0  -1.0 1.0   2 16 float num_delays>6;delay=1 \n"
  "DINLV8 Dly8InLev 0  -1.0 1.0   2 16 float num_delays>7;delay=1 \n"
  "\n"
  "# Delay lengths in milliseconds\n"
  "DLEN1 Dly1Length 0  0.0 2000   0 17 float num_delays>0;delay=1 \n"
  "DLEN2 Dly2Length 0  0.0 2000   0 17 float num_delays>1;delay=1 \n"
  "DLEN3 Dly3Length 0  0.0 2000   0 17 float num_delays>2;delay=1 \n"
  "DLEN4 Dly4Length 0  0.0 2000   0 17 float num_delays>3;delay=1 \n"
  "DLEN5 Dly5Length 0  0.0 200    1 17 float num_delays>4;delay=1 \n"
  "DLEN6 Dly6Length 0  0.0 200    1 17 float num_delays>5;delay=1 \n"
  "DLEN7 Dly7Length 0  0.0 200    2 17 float num_delays>6;delay=1 \n"
  "DLEN8 Dly8Length 0  0.0 200    2 17 float num_delays>7;delay=1 \n"
  "\n"
  "\n"
  "# Delay output levels\n"
  "DLEV1 Dly1OutLev 0  0.0 1.0   2 18 float num_delays>0;delay=1 \n"
  "DLEV2 Dly2OutLev 0  0.0 1.0   2 18 float num_delays>1;delay=1 \n"
  "DLEV3 Dly3OutLev 0  0.0 1.0   2 18 float num_delays>2;delay=1 \n"
  "DLEV4 Dly4OutLev 0  0.0 1.0   2 18 float num_delays>3;delay=1 \n"
  "DLEV5 Dly5OutLev 0  0.0 1.0   2 18 float num_delays>4;delay=1 \n"
  "DLEV6 Dly6OutLev 0  0.0 1.0   2 18 float num_delays>5;delay=1 \n"
  "DLEV7 Dly7OutLev 0  0.0 1.0   2 18 float num_delays>6;delay=1 \n"
  "DLEV8 Dly8OutLev 0  0.0 1.0   2 18 float num_delays>7;delay=1 \n"
  "\n"
  "\n"
  ...
  "CDST1 Cont1Dest 0 0.0 127 0 20 fparname num_mods>0;mods=1\n"
  "CDST2 Cont2Dest 0 0.0 127 0 20 fparname num_mods>1;mods=1\n"
  "CDST3 Cont3Dest 0 0.0 127 0 20 fparname num_mods>2;mods=1\n"
  "CDST4 Cont4Dest 0 0.0 127 0 20 fparname num_mods>3;mods=1\n"
  "\n"
  "# Note transition time in seconds\n"
  "LEGLEN LegatoLen 0 0.0 1.0 2 17 float legato=1 \n"
  "\n"
  ...
  "PSCALE PitchScale 0 -1.0 2.0 2 18 float pscale=1 \n"
  "\n";
