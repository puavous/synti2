...
const std::string defPatch = "# Default patch; \n"
  ...
  "# this; also variable number of operators, of course..) zero is always\n"
  "# allowed, i.e., 0xffff equals range 0-15, 0xfffe\n"
  ...
  "PHASE  ResetPhases  0 0x0001   0 5 switch      num_ops>0;phase>0 \n"
  "\n"
  "HARM1  Op1Wav       0 0x00ff   0 2 numeric1    num_ops>0;waves>0 \n"
  "HARM2  Op2Wav       0 0x00ff   0 2 numeric1    num_ops>1;waves>0 \n"
  "HARM3  Op3Wav       0 0x00ff   0 2 numeric1    num_ops>2;waves>0 \n"
  "HARM4  Op4Wav       0 0x00ff   0 2 numeric1    num_ops>3;waves>0 \n"
  "\n"
  "POWR1  Op1Power     0 0x0003   0 3 numeric1    num_ops>0;cube>0 \n"
  "POWR2  Op2Power     0 0x0003   0 3 numeric1    num_ops>1;cube>0 \n"
  "POWR3  Op3Power     0 0x0003   0 3 numeric1    num_ops>2;cube>0 \n"
  "POWR4  Op4Power     0 0x0003   0 3 numeric1    num_ops>3;cube>0 \n"
  "\n"
  "# Indices of the operator amplitude envelopes\n"
  "EAMP1  Op1AmpEnv    0 0x002f   0 0 numericOff1 num_ops>0;num_envs>0 \n"
  "EAMP2  Op2AmpEnv    0 0x002f   0 0 numericOff1 num_ops>1;num_envs>0 \n"
  "EAMP3  Op3AmpEnv    0 0x002f   0 0 numericOff1 num_ops>2;num_envs>0 \n"
  "EAMP4  Op4AmpEnv    0 0x002f   0 0 numericOff1 num_ops>3;num_envs>0 \n"
  "EAMPN  NoiseAmpEnv  0 0x002f   0 4 numericOff1 noise>0;num_envs>0 \n"
  "\n"
  "# Indices of the pitch envelopes\n"
  "EPIT1  Op1PitchEnv  0 0x002f   0 1 numericOff1 num_ops>0;num_envs>0;pitenv>0 \n"
  "EPIT2  Op2PitchEnv  0 0x002f   0 1 numericOff1 num_ops>1;num_envs>0;pitenv>0 \n"
  "EPIT3  Op3PitchEnv  0 0x002f   0 1 numericOff1 num_ops>2;num_envs>0;pitenv>0 \n"
  "EPIT4  Op4PitchEnv  0 0x002f   0 1 numericOff1 num_ops>3;num_envs>0;pitenv>0 \n"
  "\n"
  "EPAN   PanEnv       0 0x002f   0 2 numericOff1 num_envs>0;panenv>0;stereo>0\n"
  "EFILC  FiltCutEnv   0 0x002f   0 3 numericOff1 num_envs>0;fcutenv>0;filter>0\n"
  "EFILR  FiltResEnv   0 0x002f   0 3 numericOff1 num_envs>0;fresenv>0;filter>0\n"
  "\n"
  ...
  "FFOLL  FiltFollowOsc 0 0x000f  0 17 switch     num_ops>0;filter>0;fpfollow>0 \n"
  "\n"
  "# Squash channel output \n"
  "CSQUASH ChannelSquash 0 0x000f 0 5  switch     csquash>0 \n"
  "\n"
  ...
  "ENV1K1T En1:1T 0 0 0.255  3 6 float num_envs>0;num_knees>0 \n"
  ...
  "PBAM1   Op1BendAmt 0 0.0 24.0 1 18 float num_ops>0;pbend>0 \n"
  ...
  "PBVAL   PitchDESTNoEdt 0 -1.0  1.0  2 18 void num_mods>;mods>0;pbend>0 \n"
  "\n"
  "\n"
  ...
  "CDST1   Cont1Dest  0  0.0 127   0 19 fparname num_mods>0;mods>0\n"
  "CDST2   Cont2Dest  0  0.0 127   0 19 fparname num_mods>1;mods>0\n"
  "CDST3   Cont3Dest  0  0.0 127   0 19 fparname num_mods>2;mods>0\n"
  "CDST4   Cont4Dest  0  0.0 127   0 19 fparname num_mods>3;mods>0\n"
  "\n"
