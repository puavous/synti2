...
content = ""
content += "  0xf0, 0x00, 0x00, 0x00, /* zeros in place of manufacturer ID */\n"
content += "  0x00, 0x00, /* 14bit operation code */\n"
content += "  0x00, 0x00, /* 14bit address /location indicator */\n"
totlen = 9
for ipat in range(pat+1):
    # FIXME Hardcoded:
    int3_data = data[ipat][0:16]
    int7_data = data[ipat][16:32]
    float_data = data[ipat][32:(32+128)]
    totlen += 16+16+(4*128)
